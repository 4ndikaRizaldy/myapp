...
with st.container():    
    col1, col2 = st.columns([10,120])

    with col1:
        st.image("logo/android-chrome-512x512.png", width=100)

    with col2:
        st.markdown(
        """
        <h2 style='text-align: center; color: #FFAC08;'>Channa Fish Classification Dashboard</h2>
        <p style='text-align: center;'>Selamat Datang Dashboard Klasifikasi Ikan Channa!</p>
        """,
...
with st.container():
    ...
    with st.container():
        ...
        st.markdown("""
                <p style='text-align: justify;'> Channa Fish Classification merupakan sebuah aplikasi berbasis website yang berfungsi untuk mengklasifikasikan sebuah gambar ikan channa ke dalam kelompok ikan channa tertentu.
